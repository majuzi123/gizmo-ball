    ...
    public Common(GamePanel gamePanel) {
        ...
        world.setContactListener(new ContactListener() { // 设置碰撞监听，用于黑洞吸收
            ...
            public void beginContact(Contact contact) {
                ...
                Component component1 = gamePanel.getComponentAt((int)position1.x, (int)position1.y);
                Component component2 = gamePanel.getComponentAt((int)position2.x, (int)position2.y);
